(function () {
  ...
  function load() {
    ...
    //   inputCSS(window.lib_path + "/leaflet/my.css");
    ...
    if (inArray(includes, 'leaflet.geometryutil')) {
      inputScript(window.lib_path + "/leaflet.geometryutil/geometryutil.js");
    }
    ...
    if (inArray(includes, "blurCanvas")) {
      inputScript(window.lib_path + "/blurCanvas/L.BlurCanvas.js");
    }
    ...
    if (inArray(includes, "leaflet.ChineseTmsProviders")) {
      inputScript(window.lib_path + "/leaflet.ChineseTmsProviders/leaflet.ChineseTmsProviders.js");
    }
    if (inArray(includes, "iconLayers")) {
      inputScript(window.lib_path + "/iconLayers/iconLayers.css");
      inputScript(window.lib_path + "/iconLayers/iconLayers.js");
    }
  }
